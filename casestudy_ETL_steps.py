...
Below is complete Python ETL pipeline that you can drop straight into your `scilit-case-study` repo under `src/`.
...
3. DDL + LOAD everything into MySQL DW via SQLAlchemy  
